...
<div id="title">
      ...
      <div id="topsearch">
			...
			<input name="s" size="25" value="" class="form_text_input" type="text" />&nbsp;<input name="submit" class="searchsubmit" value="Go" type="submit" />
    	    </form>
      </div>
        <img src="images/spacer.gif" alt="Free WordPress Themes" width="900" height="1" />
    </div>
    </div><!-- end of header --> 
<div id="wrap">
<?php
